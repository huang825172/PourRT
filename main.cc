...
//                    pixel_out[ray_index * 4 + 0] = (char) (ray_set[ray_index].color[0] * 255 * rand());
//                    pixel_out[ray_index * 4 + 1] = (char) (ray_set[ray_index].color[1] * 255 * rand());
//                    pixel_out[ray_index * 4 + 2] = (char) (ray_set[ray_index].color[2] * 255 * rand());
//                    pixel_out[ray_index * 4 + 3] = (char) (ray_set[ray_index].color[3] * 255 * rand());
//                }
//            }
//            SDL_PollEvent(&event);
//            switch (event.type) {
...
//            SDL_RenderPresent(renderer);
            ...
            std::cout<< "frame with " << config.mesh_size << " faces render with rate " << 1.0/diff.count() << "fps" << std::endl;
        }
    } catch (cl::Error &error) {
